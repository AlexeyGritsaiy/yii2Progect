...
<div class="properties-listing spacer">
    ...
    <div class="row">
        <div class="col-lg-3 col-sm-4 ">
            ...
            <div class="search-form"><h4><span class="glyphicon glyphicon-search"></span> Поиск по...</h4>
                <?= Html::textInput('property', $request->get('property'),
                    ['class' => 'form-control', 'placeholder' => 'Поиск по параметрам']) ?>
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="properties">
                            <div class="image-holder"><img
                                        src="<?= \frontend\components\Common::getImageAdvert($row)[0] ?>"
                            ...
                            <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom"
                                                              ...
                                                              alt="bdshkldsjid"><?= $row['bedroom'] ?></span>
